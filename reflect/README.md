...
- [type Kind](Kind.md)&nbsp;&nbsp;&nbsp;&nbsp;// 一种数据类型
    ...
    - const Int&nbsp;&nbsp;&nbsp;&nbsp;// 整数（有符号）
    - const Int8&nbsp;&nbsp;&nbsp;&nbsp;// 整数8位（有符号）
    - const Int16&nbsp;&nbsp;&nbsp;&nbsp;// 整数16位（有符号）
    - const Int32&nbsp;&nbsp;&nbsp;&nbsp;// 整数32位（有符号）
    - const Int64&nbsp;&nbsp;&nbsp;&nbsp;// 整数64位（有符号）
    - const Uint&nbsp;&nbsp;&nbsp;&nbsp;// 整数（无符号）
    - const Uint8&nbsp;&nbsp;&nbsp;&nbsp;// 整数8（无符号）
    - const Uint16&nbsp;&nbsp;&nbsp;&nbsp;// 整数16（无符号）
    - const Uint32&nbsp;&nbsp;&nbsp;&nbsp;// 整数（无符号）
    - const Uint64&nbsp;&nbsp;&nbsp;&nbsp;// 整数（无符号）
    - const Uintptr&nbsp;&nbsp;&nbsp;&nbsp;// 整数（指针,无符号）
    - const Float32&nbsp;&nbsp;&nbsp;&nbsp;// 浮点数32位
    - const Float64&nbsp;&nbsp;&nbsp;&nbsp;// 浮点数64位
    - const Complex64&nbsp;&nbsp;&nbsp;&nbsp;// 复数64位
    - const Complex128&nbsp;&nbsp;&nbsp;&nbsp;// 复数128位
    - const Array&nbsp;&nbsp;&nbsp;&nbsp;// 数组
    - const Chan&nbsp;&nbsp;&nbsp;&nbsp;// 信道
    - const Func&nbsp;&nbsp;&nbsp;&nbsp;// 函数
    - const Interface&nbsp;&nbsp;&nbsp;&nbsp;// 接口
